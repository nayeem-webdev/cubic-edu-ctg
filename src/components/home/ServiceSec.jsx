    ...
    <div className="w-full bg-gray-50">
      <div className="max-w-7xl mx-auto py-28 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
          {/* sec start */}
          {/* Card 1 */}
          <div className="flex justify-between items-center border-2 p-4 rounded-lg border-primary hover:translate-x-2 transition-all bg-white/20 backdrop-blur-md">
