...
const Button = ({
  ...
  const variants = {
    primary:
      "bg-[#0859aa] text-white hover:bg-[#0a4d8f] focus:ring-[#0859aa]/50 active:bg-[#094180] shadow-sm hover:shadow-md",
    secondary:
      "bg-[#5db946] text-white hover:bg-[#4da536] focus:ring-[#5db946]/50 active:bg-[#45932f] shadow-sm hover:shadow-md",
    danger:
